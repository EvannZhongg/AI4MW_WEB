...
urlpatterns = [
    ...
    path("api/chat-search", llm_views.search_messages, name="search_messages"),
    path(
        "api/messages/<int:message_id>/attachments/<int:attachment_index>",
        llm_views.serve_message_attachment,
    ...
    path("auth/github/login/", views.begin_github_login, name="begin_github_login"),
